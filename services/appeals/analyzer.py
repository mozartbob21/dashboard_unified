...
EMOTION_DEFINITIONS = {
    ...
    "angry": {
        ...
        "patterns": [
            ...
            # WATER_RESONANCE_PATCH_V1: дополнительные маркеры по водоснабжению / ЖКХ
            {"pattern": r"\bиздевательств\w*\b|\bиздеваетесь\b|\bиздеваться\b", "weight": 0.42, "marker": "издевательство"},
            {"pattern": r"\bпозор\b", "weight": 0.38, "marker": "позор"},
            {"pattern": r"\bбардак\b", "weight": 0.34, "marker": "бардак"},
            {"pattern": r"\bдостал[аио]?\w*\b", "weight": 0.35, "marker": "достали"},
            {"pattern": r"\bжуть\b|\bжутк\w*\b", "weight": 0.32, "marker": "жуть"},
            {"pattern": r"\bдурдом\b", "weight": 0.34, "marker": "дурдом"},
            {"pattern": r"\bмаразм\b", "weight": 0.32, "marker": "маразм"},
            {"pattern": r"\bвсем\s+пофиг\b|\bвсем\s+плевать\b|\bвсем\s+все\s+равно\b|\bвсем\s+всё\s+равно\b", "weight": 0.42, "marker": "всем всё равно"},
            {"pattern": r"\bотмазк\w*\b", "weight": 0.36, "marker": "отмазки"},
            {"pattern": r"\bотговорк\w*\b", "weight": 0.34, "marker": "отговорки"},
            {"pattern": r"формальн\w+\s+отписк\w*", "weight": 0.42, "marker": "формальная отписка"},
            {"pattern": r"фиктивн\w+\s+акт\w*", "weight": 0.44, "marker": "фиктивные акты"},
            {"pattern": r"шаблонн\w+\s+ответ\w*", "weight": 0.34, "marker": "шаблонный ответ"},
            {"pattern": r"закрыва\w+\s+заявк\w*", "weight": 0.36, "marker": "закрывают заявки"},
            {"pattern": r"заявк\w+\s+закрыва\w*", "weight": 0.36, "marker": "заявки закрывают"},
            {"pattern": r"корм\w+\s+завтрак\w*", "weight": 0.38, "marker": "кормят завтраками"},
            {"pattern": r"ничего\s+не\s+дела\w*", "weight": 0.40, "marker": "ничего не делают"},
            {"pattern": r"ничего\s+не\s+предпринима\w*", "weight": 0.40, "marker": "ничего не предпринимают"},
            {"pattern": r"не\s+предпринима\w+\s+никаких\s+действий", "weight": 0.42, "marker": "не предпринимают действий"},
            {"pattern": r"не\s+реагир\w*", "weight": 0.40, "marker": "не реагируют"},
            {"pattern": r"игнорир\w*", "weight": 0.40, "marker": "игнорируют"},
            {"pattern": r"не\s+отвеча\w+\s+на\s+звонк\w*", "weight": 0.34, "marker": "не отвечают на звонки"},
            {"pattern": r"никто\s+не\s+отвечает", "weight": 0.36, "marker": "никто не отвечает"},
            {"pattern": r"нет\s+обратн\w+\s+связ\w*", "weight": 0.32, "marker": "нет обратной связи"},
            {"pattern": r"за\s+что\s+плат\w*", "weight": 0.34, "marker": "за что платим"},
            {"pattern": r"платим\s+как\s+за\s+питьев\w+\s+вод\w*", "weight": 0.36, "marker": "платим как за питьевую воду"},
            {"pattern": r"покупа\w+\s+вод\w+", "weight": 0.24, "marker": "вынуждены покупать воду"},
            {"pattern": r"требу\w+\s+перерасч[её]т", "weight": 0.34, "marker": "требуют перерасчёт"},
        ],
    },
    ...
    "anxious": {
        ...
        "patterns": [
            ...
            # WATER_RESONANCE_PATCH_V1: риск здоровью / санитарная опасность
            {"pattern": r"угроз[ауы]\s+здоровь\w*", "weight": 0.58, "marker": "угроза здоровью"},
            {"pattern": r"вред\s+здоровь\w*", "weight": 0.50, "marker": "вред здоровью"},
            {"pattern": r"опасно\s+употреблять", "weight": 0.55, "marker": "опасно употреблять"},
            {"pattern": r"опасно\s+пить", "weight": 0.55, "marker": "опасно пить"},
            {"pattern": r"опасно\s+пользоваться", "weight": 0.48, "marker": "опасно пользоваться"},
            {"pattern": r"непригодн\w+\s+для\s+употреблен\w*", "weight": 0.55, "marker": "непригодна для употребления"},
            {"pattern": r"не\s+пригодн\w+\s+для\s+пить\w*", "weight": 0.55, "marker": "непригодна для питья"},
            {"pattern": r"нельзя\s+пить", "weight": 0.46, "marker": "нельзя пить"},
            {"pattern": r"нельзя\s+использовать", "weight": 0.42, "marker": "нельзя использовать"},
            {"pattern": r"пить\s+невозможно", "weight": 0.42, "marker": "пить невозможно"},
            {"pattern": r"мыться\s+нельзя|нельзя\s+мыться", "weight": 0.38, "marker": "нельзя мыться"},
            {"pattern": r"готовить\s+нельзя|нельзя\s+готовить", "weight": 0.40, "marker": "нельзя готовить"},
            {"pattern": r"\bчерв[ьи]\w*\b", "weight": 0.62, "marker": "черви в воде"},
            {"pattern": r"\bслиз[ьи]\w*\b", "weight": 0.48, "marker": "слизь"},
            {"pattern": r"\bфекали\w*\b", "weight": 0.62, "marker": "фекалии"},
            {"pattern": r"запах\s+канализаци\w*", "weight": 0.55, "marker": "запах канализации"},
            {"pattern": r"воня\w+\s+канализаци\w*", "weight": 0.50, "marker": "воняет канализацией"},
            {"pattern": r"\bсероводород\b|\bсероводород\w+\s+запах\b", "weight": 0.50, "marker": "сероводород"},
            {"pattern": r"тухл\w+\s+запах", "weight": 0.45, "marker": "тухлый запах"},
            {"pattern": r"запах\s+болот\w*", "weight": 0.38, "marker": "запах болота"},
            {"pattern": r"ржав\w+\s+вод\w*", "weight": 0.30, "marker": "ржавая вода"},
            {"pattern": r"коричнев\w+\s+вод\w*", "weight": 0.34, "marker": "коричневая вода"},
            {"pattern": r"желт\w+\s+вод\w*|ж[её]лт\w+\s+вод\w*", "weight": 0.30, "marker": "желтая вода"},
            {"pattern": r"оранжев\w+\s+вод\w*", "weight": 0.30, "marker": "оранжевая вода"},
            {"pattern": r"грязн\w+\s+вод\w*", "weight": 0.34, "marker": "грязная вода"},
            {"pattern": r"вод\w+\s+цвета\s+квас\w*", "weight": 0.36, "marker": "вода цвета кваса"},
            {"pattern": r"вод\w+\s+цвета\s+кока-?кол\w*", "weight": 0.36, "marker": "вода цвета кока-колы"},
            {"pattern": r"\bпожил\w+\b|\bстарик\w*\b|\bпенсионер\w*\b", "weight": 0.22, "marker": "пожилые люди"},
            {"pattern": r"\bбеременн\w+\b", "weight": 0.28, "marker": "беременные"},
            {"pattern": r"\bмногодетн\w+\b", "weight": 0.24, "marker": "многодетные"},
            {"pattern": r"маленьк\w+\s+реб[её]нок", "weight": 0.28, "marker": "маленький ребенок"},
            {"pattern": r"новорожденн\w+\s+реб[её]н\w*", "weight": 0.35, "marker": "новорожденный ребенок"},
            {"pattern": r"контактн\w+\s+дерматит", "weight": 0.50, "marker": "контактный дерматит"},
            {"pattern": r"сыпь|чесаться|чеш\w+", "weight": 0.32, "marker": "кожные реакции"},
            {"pattern": r"вопрос\s+жизни\s+и\s+смерти", "weight": 0.70, "marker": "вопрос жизни и смерти"},
            {"pattern": r"смертельн\w+", "weight": 0.65, "marker": "смертельно"},
            {"pattern": r"трав\w+\s+люд\w*|трав\w+\s+дет\w*|нас\s+трав\w*", "weight": 0.58, "marker": "травят людей"},
        ],
    },
    ...
    "sad": {
        ...
        "patterns": [
            ...
            # WATER_RESONANCE_PATCH_V1: беспомощность / отсутствие информации
            {"pattern": r"что\s+нам\s+делать", "weight": 0.34, "marker": "что нам делать"},
            {"pattern": r"как\s+быть", "weight": 0.34, "marker": "как быть"},
            {"pattern": r"как\s+жить", "weight": 0.38, "marker": "как жить"},
            {"pattern": r"как\s+людям\s+пользоваться", "weight": 0.34, "marker": "как людям пользоваться"},
            {"pattern": r"куда\s+нам\s+обращаться", "weight": 0.42, "marker": "куда нам обращаться"},
            {"pattern": r"никому\s+нет\s+дела", "weight": 0.42, "marker": "никому нет дела"},
            {"pattern": r"нет\s+никакой\s+информации", "weight": 0.34, "marker": "нет информации"},
            {"pattern": r"информаци\w+\s+полностью\s+отсутствует", "weight": 0.36, "marker": "информация отсутствует"},
            {"pattern": r"сроки\s+не\s+известн\w*", "weight": 0.34, "marker": "сроки неизвестны"},
            {"pattern": r"вынуждены\s+покупать\s+вод\w*", "weight": 0.34, "marker": "вынуждены покупать воду"},
            {"pattern": r"остал\w+\s+без\s+вод\w*", "weight": 0.38, "marker": "остались без воды"},
            {"pattern": r"сидим\s+без\s+вод\w*", "weight": 0.38, "marker": "сидим без воды"},
            {"pattern": r"без\s+вод\w+\s+нам\s+никак", "weight": 0.42, "marker": "без воды никак"},
        ],
    },
    ...
    "urgent": {
        ...
        "patterns": [
            ...
            # WATER_RESONANCE_PATCH_V1: срочность по водоснабжению
            {"pattern": r"примите\s+срочн\w+\s+мер\w*", "weight": 0.55, "marker": "примите срочные меры"},
            {"pattern": r"срочно\s+принять\s+меры", "weight": 0.55, "marker": "срочно принять меры"},
            {"pattern": r"как\s+можно\s+скорее", "weight": 0.42, "marker": "как можно скорее"},
            {"pattern": r"нужно\s+срочно", "weight": 0.45, "marker": "нужно срочно"},
            {"pattern": r"сегодня\s+же", "weight": 0.42, "marker": "сегодня же"},
            {"pattern": r"доставить\s+вод\w*|привезти\s+вод\w*|подвоз\s+вод\w*|водовоз", "weight": 0.38, "marker": "нужен подвоз воды"},
            {"pattern": r"дайте\s+вод\w*", "weight": 0.38, "marker": "дайте воду"},
            {"pattern": r"обеспечить\s+питьев\w+\s+вод\w*", "weight": 0.42, "marker": "обеспечить питьевой водой"},
        ],
    },
...
INTENSIFIERS = [
    ...
    r"\bкаждый\s+день\b",
    r"\bкаждый\s+вечер\b",
    r"\bкаждую\s+неделю\b",
    r"\bнесколько\s+раз\b",
    r"\bснова\b",
    r"\bопять\b",
    r"\bвновь\b",
    r"\bуже\b",
...
def extract_duration_days(text):
    ...
    fuzzy_patterns = [
        ...
        (r"уже\s+год", 365),
        (r"более\s+года", 365),
        (r"несколько\s+лет", 730),
        (r"много\s+лет", 730),
        (r"более\s+\d+\s*-?х?\s*лет", 730),
        (r"не\s+первый\s+раз", 14),
        (r"в\s+очередной\s+раз", 14),
        (r"снова", 7),
        (r"опять", 7),
        (r"с\s+выходных", 3),
...
JKH_FACT_PATTERNS = [
    ...
    r"\bфильтр\w*\b",
    r"\bржав\w*\b",
    r"\bгрязн\w+\s+вод\w*\b",
    r"\bкоричнев\w+\s+вод\w*\b",
    r"\bжелт\w+\s+вод\w*\b",
    r"\bж[её]лт\w+\s+вод\w*\b",
    r"\bоранжев\w+\s+вод\w*\b",
    r"\bсероводород\b",
    r"\bчерв[ьи]\w*\b",
    r"\bслиз[ьи]\w*\b",
    r"\bфекали\w*\b",
...
def analyze_appeal(subject, text):
    ...
    conf_text = estimate_emotion_confidence(emotion)
    fact_score, fact_reasons = calculate_fact_score(
        full_text,
        address,
        criticality["criticality_reasons"],
        duration_days,
    )
    systematicity_days = extract_systematicity_days_from_text(full_text)
    ...
    priority_level, priority_label = get_priority(final_index["index_final"])
    ...
    return {
        ...
        "index_final": final_index["index_final"],
        "index_details": final_index,
